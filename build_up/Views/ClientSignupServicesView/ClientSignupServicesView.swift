...
struct ClientSignupServicesView: View {
    @StateObject var clientSignupServicesViewModel = ClientSignupServicesViewModel()
        ...
        VStack {
            VStack {
                ...
                Image("img_sectionbackgr")
                    ...
                    .padding(.horizontal, getRelativeWidth(44.0))
                Text(StringConstants.kMsgWhatServices)
                    .font(FontScheme.kMulishRomanRegular(size: getRelativeHeight(24.0)))
                    .fontWeight(.regular)
                    .foregroundColor(ColorConstants.Black900)
                    .minimumScaleFactor(0.5)
                    .multilineTextAlignment(.center)
                    .frame(width: getRelativeWidth(184.0), height: getRelativeHeight(72.0),
                           alignment: .center)
                    .padding(.horizontal, getRelativeWidth(44.0))
                ZStack {}
                    .hideNavigationBar()
...
struct ClientSignupServicesView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignupServicesView()
    }
}
