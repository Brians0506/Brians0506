...
struct SPSignupwhybuildupView: View {
    @StateObject var sPSignupwhybuildupViewModel = SPSignupwhybuildupViewModel()
        ...
        VStack {
            VStack {
                ...
                .frame(width: getRelativeWidth(48.0), height: getRelativeHeight(24.0),
                       alignment: .leading)
                .padding(.vertical, getRelativeHeight(168.0))
...
struct SPSignupwhybuildupView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupwhybuildupView()
    }
}
