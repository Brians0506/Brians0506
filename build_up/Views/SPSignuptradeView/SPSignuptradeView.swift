...
struct SPSignuptradeView: View {
    @StateObject var sPSignuptradeViewModel = SPSignuptradeViewModel()
            ...
            VStack {
                VStack {
                    ...
                    Text(StringConstants.kMsgListServiceS)
                        ...
                        .padding(.horizontal, getRelativeWidth(107.0))
                    HStack {
                        ...
                        Image("img_forward")
                            ...
                            .clipped()
                            .onTapGesture {
                                sPSignuptradeViewModel.nextScreen = "SPSignupcompanyView"
                            }
                    }
                ...
                Group {
                    NavigationLink(destination: SPSignupcompanyView(),
                                   ...
                                   selection: $sPSignuptradeViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SPSignuptradeView_Previews: PreviewProvider {
