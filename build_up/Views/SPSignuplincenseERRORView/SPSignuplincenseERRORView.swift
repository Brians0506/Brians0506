...
struct SPSignuplincenseERRORView: View {
    @StateObject var sPSignuplincenseERRORViewModel = SPSignuplincenseERRORViewModel()
            ...
            VStack {
                VStack {
                    ...
                    Text(StringConstants.kMsgLicenseVerific)
                        ...
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(214.0), height: getRelativeHeight(31.0),
                               alignment: .topLeading)
                        .padding(.top, getRelativeHeight(9.0))
                        .padding(.horizontal, getRelativeWidth(36.0))
                    Text(StringConstants.kMsgTypeInContrac)
                        .font(FontScheme.kSarabunMediumItalic(size: getRelativeHeight(14.0)))
                        .fontWeight(.medium)
                        .foregroundColor(ColorConstants.Black900)
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(217.0), height: getRelativeHeight(19.0),
                               alignment: .topLeading)
                    ...
                    ZStack(alignment: .leading) {
                        ...
                        Image("img_back_24x24")
                            ...
                            .onTapGesture {
                                sPSignuplincenseERRORViewModel.nextScreen = "SPSignupexperienceView"
                            }
                    }
                    .hideNavigationBar()
                    .frame(width: getRelativeWidth(41.0), height: getRelativeHeight(24.0),
                           alignment: .center)
                    .padding(.vertical, getRelativeHeight(203.0))
                    .padding(.horizontal, getRelativeWidth(36.0))
                }
                ...
                Group {
                    NavigationLink(destination: SPSignupexperienceView(),
                                   ...
                                   selection: $sPSignuplincenseERRORViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SPSignuplincenseERRORView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignuplincenseERRORView()
    }
}
