...
struct SPSignupaddexperrorView: View {
    @StateObject var sPSignupaddexperrorViewModel = SPSignupaddexperrorViewModel()
            ...
            VStack {
                ZStack {
                    VStack {
                        ...
                        Text(StringConstants.kMsgAddingExperie)
                            .font(FontScheme.kSarabunRegular(size: getRelativeHeight(10.0)))
                            .fontWeight(.regular)
                            .foregroundColor(ColorConstants.Red800)
                            .minimumScaleFactor(0.5)
                            .multilineTextAlignment(.leading)
                            .frame(width: getRelativeWidth(132.0), height: getRelativeHeight(13.0),
                                   alignment: .topLeading)
                        ...
                        ZStack(alignment: .leading) {
                            ...
                            Image("img_back_24x24")
                                ...
                                .onTapGesture {
                                    sPSignupaddexperrorViewModel
                                        .nextScreen = "SPSignupwhybuildupView"
                                }
                        }
                        .hideNavigationBar()
                    ...
                    .frame(width: getRelativeWidth(291.0), height: getRelativeHeight(584.0),
                           alignment: .center)
                ...
                Group {
                    NavigationLink(destination: SPSignupwhybuildupView(),
                                   ...
                                   selection: $sPSignupaddexperrorViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SPSignupaddexperrorView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupaddexperrorView()
    }
}
