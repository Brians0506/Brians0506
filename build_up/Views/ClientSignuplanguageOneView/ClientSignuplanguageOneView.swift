...
struct ClientSignuplanguageOneView: View {
    @StateObject var clientSignuplanguageOneViewModel = ClientSignuplanguageOneViewModel()
...
struct ClientSignuplanguageOneView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignuplanguageOneView()
    }
}
