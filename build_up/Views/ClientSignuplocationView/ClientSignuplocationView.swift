...
struct ClientSignuplocationView: View {
    @StateObject var clientSignuplocationViewModel = ClientSignuplocationViewModel()
        ...
        VStack {
            VStack(alignment: .leading, spacing: 0) {
                ...
                .frame(width: getRelativeWidth(48.0), height: getRelativeHeight(24.0),
                       alignment: .center)
                .padding(.vertical, getRelativeHeight(220.0))
                .padding(.horizontal, getRelativeWidth(36.0))
            }
...
struct ClientSignuplocationView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignuplocationView()
    }
}
