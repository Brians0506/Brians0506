...
struct SPSignup35View: View {
    @StateObject var sPSignup35ViewModel = SPSignup35ViewModel()
            ...
            VStack {
                            ...
                            Group {
                                ZStack(alignment: .leading) {
                                    ...
                                    Image("img_back_24x24")
                                        ...
                                        .onTapGesture {
                                            sPSignup35ViewModel.nextScreen = "SPSignupexpThreeView"
                                        }
                                }
                                .hideNavigationBar()
                ...
                Group {
                    NavigationLink(destination: SPSignupexpThreeView(),
                                   ...
                                   selection: $sPSignup35ViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SPSignup35View_Previews: PreviewProvider {
