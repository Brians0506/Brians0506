...
struct ClientSignupdevTwoView: View {
    @StateObject var clientSignupdevTwoViewModel = ClientSignupdevTwoViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    Group {
                        ...
                        Text(StringConstants.kMsgPropertyManage)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignupdevTwoViewModel.nextScreen = "ClientSignuppropOneView"
                            }
                        ...
                        Text(StringConstants.kLblProjectManager)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignupdevTwoViewModel.nextScreen = "ClientSignupprojThreeView"
                            }
                        Button(action: {
                            clientSignupdevTwoViewModel.nextScreen = "ClientSignuppropFourView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        .padding(.horizontal, getRelativeWidth(44.0))
                        Button(action: {
                            clientSignupdevTwoViewModel.nextScreen = "ClientSignuptrustFiveView"
                        }, label: {
                            HStack(spacing: 0) {
                    ...
                    Group {
                        Button(action: {
                            clientSignupdevTwoViewModel.nextScreen = "ClientSignuphmoSixView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        .padding(.horizontal, getRelativeWidth(44.0))
                        Button(action: {
                            clientSignupdevTwoViewModel.nextScreen = "ClientSignuphmoSevenView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        HStack {
                            Image("img_back_24x24")
                                ...
                                .clipped()
                                .onTapGesture {
                                    clientSignupdevTwoViewModel.nextScreen = "ClientSignupEmailView"
                                }
                            Spacer()
                            Image("img_forward")
                                .resizable()
                ...
                Group {
                    NavigationLink(destination: ClientSignupEmailView(),
                                   ...
                                   selection: $clientSignupdevTwoViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ClientSignupdevTwoView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignupdevTwoView()
    }
}
