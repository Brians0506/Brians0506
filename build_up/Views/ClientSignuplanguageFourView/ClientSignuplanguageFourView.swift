...
struct ClientSignuplanguageFourView: View {
    @StateObject var clientSignuplanguageFourViewModel = ClientSignuplanguageFourViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    Text(StringConstants.kLblEnglish)
                        ...
                        .padding(.horizontal, getRelativeWidth(44.0))
                        .onTapGesture {
                            clientSignuplanguageFourViewModel
                ...
                Group {
                    NavigationLink(destination: ClientSignuplanguageOneView(),
                                   ...
                                   selection: $clientSignuplanguageFourViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ClientSignuplanguageFourView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignuplanguageFourView()
    }
}
