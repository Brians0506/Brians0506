...
struct SPSignupwhyBUerrorView: View {
    @StateObject var sPSignupwhyBUerrorViewModel = SPSignupwhyBUerrorViewModel()
            ...
            VStack {
                VStack {
                    ...
                    ZStack(alignment: .leading) {
                        ...
                        Image("img_back_24x24")
                            ...
                            .onTapGesture {
                                sPSignupwhyBUerrorViewModel.nextScreen = "SPSignupprofilevideoView"
                            }
                    }
                    .hideNavigationBar()
                ...
                Group {
                    NavigationLink(destination: SPSignupprofilevideoView(),
                                   ...
                                   selection: $sPSignupwhyBUerrorViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SPSignupwhyBUerrorView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupwhyBUerrorView()
    }
}
