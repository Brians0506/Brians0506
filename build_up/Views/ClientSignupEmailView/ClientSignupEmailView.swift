...
struct ClientSignupEmailView: View {
    @StateObject var clientSignupEmailViewModel = ClientSignupEmailViewModel()
...
struct ClientSignupEmailView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignupEmailView()
    }
}
