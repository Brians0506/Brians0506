...
struct SPSignuplocationerrorView: View {
    @StateObject var sPSignuplocationerrorViewModel = SPSignuplocationerrorViewModel()
            ...
            VStack {
                VStack {
                    ...
                    ZStack(alignment: .leading) {
                        ...
                        Image("img_back_24x24")
                            ...
                            .onTapGesture {
                                sPSignuplocationerrorViewModel.nextScreen = "SPSignupNameView"
                            }
                    }
                    .hideNavigationBar()
                ...
                Group {
                    NavigationLink(destination: SPSignupNameView(),
                                   ...
                                   selection: $sPSignuplocationerrorViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SPSignuplocationerrorView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignuplocationerrorView()
    }
}
