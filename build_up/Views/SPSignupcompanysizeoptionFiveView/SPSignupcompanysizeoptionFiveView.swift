...
struct SPSignupcompanysizeoptionFiveView: View {
    @StateObject var sPSignupcompanysizeoptionFiveViewModel =
        SPSignupcompanysizeoptionFiveViewModel()
            ...
            VStack {
                ...
                Group {
                    NavigationLink(destination: SPSignupservTimeView(),
                                   ...
                                   selection: $sPSignupcompanysizeoptionFiveViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct SPSignupcompanysizeoptionFiveView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupcompanysizeoptionFiveView()
    }
}
