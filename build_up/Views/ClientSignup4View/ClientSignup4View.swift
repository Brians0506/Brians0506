...
struct ClientSignup4View: View {
    @StateObject var clientSignup4ViewModel = ClientSignup4ViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    Group {
                        ...
                        Text(StringConstants.kMsgPropertyManage)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignup4ViewModel.nextScreen = "ClientSignuppropOneView"
                            }
                        Text(StringConstants.kLblDeveloper)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignup4ViewModel.nextScreen = "ClientSignupdevTwoView"
                            }
                        Text(StringConstants.kLblProjectManager)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignup4ViewModel.nextScreen = "ClientSignupprojThreeView"
                            }
                        Button(action: {
                            clientSignup4ViewModel.nextScreen = "ClientSignuppropFourView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        .padding(.horizontal, getRelativeWidth(44.0))
                        Button(action: {
                            clientSignup4ViewModel.nextScreen = "ClientSignuptrustFiveView"
                        }, label: {
                            HStack(spacing: 0) {
                    ...
                    Group {
                        Button(action: {
                            clientSignup4ViewModel.nextScreen = "ClientSignuphmoSixView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        .padding(.horizontal, getRelativeWidth(44.0))
                        Button(action: {
                            clientSignup4ViewModel.nextScreen = "ClientSignuphmoSevenView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        HStack {
                            Image("img_back_24x24")
                                ...
                                .clipped()
                                .onTapGesture {
                                    clientSignup4ViewModel.nextScreen = "ClientSignupEmailView"
                                }
                            Spacer()
                            Image("img_forward")
                                .resizable()
                ...
                Group {
                    NavigationLink(destination: ClientSignuppropFourView(),
                                   ...
                                   selection: $clientSignup4ViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ClientSignup4View_Previews: PreviewProvider {
