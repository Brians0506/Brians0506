...
struct SPSignupuploadedvideoView: View {
    @StateObject var sPSignupuploadedvideoViewModel = SPSignupuploadedvideoViewModel()
                ...
                ZStack(alignment: .leading) {
                    ...
                    VStack {
                        VStack(alignment: .leading, spacing: 0) {
                            Text(StringConstants.kLblVideoMp4)
                            ...
                            Divider()
                                ...
                                .padding(.horizontal, getRelativeWidth(7.0))
                            HStack {
                                Text(StringConstants.kLbl134Mb)
                                    .font(FontScheme.kInterRegular(size: getRelativeHeight(6.0)))
                                    .fontWeight(.regular)
                            ...
                            .frame(width: getRelativeWidth(159.0), height: getRelativeHeight(8.0),
                                   alignment: .center)
...
struct SPSignupuploadedvideoView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupuploadedvideoView()
    }
}
