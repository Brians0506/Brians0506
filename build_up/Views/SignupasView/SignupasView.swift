...
struct SignupasView: View {
    @StateObject var signupasViewModel = SignupasViewModel()
            ...
            VStack {
                ...
                Group {
                    NavigationLink(destination: SignupasClientPickView(),
                                   ...
                                   selection: $signupasViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct SignupasView_Previews: PreviewProvider {
