...
struct SPSignuplincenseverfView: View {
    @StateObject var sPSignuplincenseverfViewModel = SPSignuplincenseverfViewModel()
...
struct SPSignuplincenseverfView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignuplincenseverfView()
    }
}
