...
struct SPSignupnameerrorView: View {
    @StateObject var sPSignupnameerrorViewModel = SPSignupnameerrorViewModel()
...
struct SPSignupnameerrorView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupnameerrorView()
    }
}
