...
struct ClientSignuphmoSixView: View {
    @StateObject var clientSignuphmoSixViewModel = ClientSignuphmoSixViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    Group {
                        ...
                        Text(StringConstants.kMsgPropertyManage)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignuphmoSixViewModel.nextScreen = "ClientSignuppropOneView"
                            }
                        Text(StringConstants.kLblDeveloper)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignuphmoSixViewModel.nextScreen = "ClientSignupdevTwoView"
                            }
                        Text(StringConstants.kLblProjectManager)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignuphmoSixViewModel.nextScreen = "ClientSignupprojThreeView"
                            }
                        Button(action: {
                            clientSignuphmoSixViewModel.nextScreen = "ClientSignuppropFourView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        .padding(.horizontal, getRelativeWidth(44.0))
                        Button(action: {
                            clientSignuphmoSixViewModel.nextScreen = "ClientSignuptrustFiveView"
                        }, label: {
                            HStack(spacing: 0) {
                    ...
                    Group {
                        Button(action: {
                            clientSignuphmoSixViewModel.nextScreen = "ClientSignup4View"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        .padding(.horizontal, getRelativeWidth(44.0))
                        Button(action: {
                            clientSignuphmoSixViewModel.nextScreen = "ClientSignuphmoSevenView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        HStack {
                            Image("img_back_24x24")
                                ...
                                .clipped()
                                .onTapGesture {
                                    clientSignuphmoSixViewModel.nextScreen = "ClientSignupEmailView"
                                }
                            Spacer()
                            Image("img_forward")
                                .resizable()
                ...
                Group {
                    NavigationLink(destination: ClientSignuppropFourView(),
                                   ...
                                   selection: $clientSignuphmoSixViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ClientSignuphmoSixView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignuphmoSixView()
    }
}
