...
struct SPSignupNameView: View {
    @StateObject var sPSignupNameViewModel = SPSignupNameViewModel()
            ...
            VStack {
                VStack {
                    ...
                    HStack {
                        ...
                        Image("img_forward")
                            ...
                            .clipped()
                            .onTapGesture {
                                sPSignupNameViewModel.nextScreen = "SPSignuplocationView"
                            }
                    }
                    .frame(width: getRelativeWidth(48.0), height: getRelativeHeight(24.0),
                           alignment: .leading)
                    .padding(.vertical, getRelativeHeight(171.0))
                ...
                Group {
                    NavigationLink(destination: SPSignuplocationView(),
                                   ...
                                   selection: $sPSignupNameViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SPSignupNameView_Previews: PreviewProvider {
