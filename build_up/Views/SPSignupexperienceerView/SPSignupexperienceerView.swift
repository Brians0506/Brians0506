...
struct SPSignupexperienceerView: View {
    @StateObject var sPSignupexperienceerViewModel = SPSignupexperienceerViewModel()
        ...
        NavigationView {
            VStack {
                ZStack {
                    VStack {
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            HStack {
                                TextField(StringConstants.kLblJobTitle,
                                          text: $sPSignupexperienceerViewModel.groupfortyeightText)
                            ...
                            HStack {
                                ...
                                HStack {
                                    TextField(StringConstants.kLblState,
                                              text: $sPSignupexperienceerViewModel
                                                  .groupfortyfiveText)
                                        .font(FontScheme
                            ...
                            .padding(.horizontal, getRelativeWidth(11.0))
                            Text(StringConstants.kLblCompanyName)
                                .font(FontScheme.kSarabunItalic(size: getRelativeHeight(12.0)))
                                .fontWeight(.regular)
                                ...
                                .padding(.horizontal, getRelativeWidth(11.0))
                            HStack {
                                TextField(StringConstants.kMsgDescribeYourP3,
                                          text: $sPSignupexperienceerViewModel.groupfortynineText)
                                    .font(FontScheme.kSarabunItalic(size: getRelativeHeight(12.0)))
                                    .foregroundColor(ColorConstants.Gray400)
                                    .padding()
                            }
                        ...
                        ZStack(alignment: .leading) {
                            ...
                            Image("img_back_24x24")
                                ...
                                .onTapGesture {
                                    sPSignupexperienceerViewModel.nextScreen = "SPSignupaddexpView"
                                }
                        }
                        .hideNavigationBar()
                    ...
                    .frame(width: getRelativeWidth(291.0), height: getRelativeHeight(650.0),
                           alignment: .center)
                    .padding(.top, getRelativeHeight(90.02))
                ...
                Group {
                    NavigationLink(destination: SPSignupaddexpView(),
                                   ...
                                   selection: $sPSignupexperienceerViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SPSignupexperienceerView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupexperienceerView()
    }
}
