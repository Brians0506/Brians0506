...
struct SPSignuplessthanoneView: View {
    @StateObject var sPSignuplessthanoneViewModel = SPSignuplessthanoneViewModel()
        ...
        NavigationView {
            VStack {
                VStack {
                    ...
                    .padding(.horizontal, getRelativeWidth(36.0))
                    Text(StringConstants.kMsgYearsInServic2)
                        .font(FontScheme.kMulishItalicRegular(size: getRelativeHeight(24.0)))
                        .fontWeight(.regular)
                        .foregroundColor(ColorConstants.Black900)
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(174.0), height: getRelativeHeight(31.0),
                               alignment: .topLeading)
                        .padding(.top, getRelativeHeight(14.0))
                        .padding(.horizontal, getRelativeWidth(36.0))
                    Text(StringConstants.kLblOneYear)
                        ...
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(150.0), height: getRelativeHeight(24.0),
                               alignment: .topLeading)
                        ...
                        .padding(.horizontal, getRelativeWidth(36.0))
                    Text(StringConstants.kLbl14Years)
                        .font(FontScheme.kSarabunItalic(size: getRelativeHeight(12.0)))
                        .fontWeight(.regular)
                        .padding(.leading, getRelativeWidth(30.0))
                        .padding(.vertical, getRelativeHeight(6.0))
                        ...
                        .padding(.horizontal, getRelativeWidth(36.0))
                    Text(StringConstants.kLbl510Years)
                        .font(FontScheme.kSarabunItalic(size: getRelativeHeight(12.0)))
                        .fontWeight(.regular)
                        .padding(.leading, getRelativeWidth(30.0))
                        ...
                        .padding(.top, getRelativeHeight(12.0))
                        .padding(.horizontal, getRelativeWidth(36.0))
                    Text(StringConstants.kLbl10Years)
                        .font(FontScheme.kSarabunItalic(size: getRelativeHeight(12.0)))
                        .fontWeight(.regular)
                    ...
                    ZStack(alignment: .leading) {
                        ...
                        Image("img_back_24x24")
                            ...
                            .onTapGesture {
                                sPSignuplessthanoneViewModel.nextScreen = "SPSignupcompanyView"
                            }
                    }
                    .hideNavigationBar()
                ...
                Group {
                    NavigationLink(destination: SPSignupcompanyView(),
                                   ...
                                   selection: $sPSignuplessthanoneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SPSignuplessthanoneView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignuplessthanoneView()
    }
}
