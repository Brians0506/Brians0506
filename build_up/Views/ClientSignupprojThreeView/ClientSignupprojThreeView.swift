...
struct ClientSignupprojThreeView: View {
    @StateObject var clientSignupprojThreeViewModel = ClientSignupprojThreeViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    Group {
                        ...
                        Text(StringConstants.kMsgPropertyManage)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignupprojThreeViewModel
                        ...
                        Text(StringConstants.kLblDeveloper)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignupprojThreeViewModel.nextScreen = "ClientSignupdevTwoView"
                            }
                        Text(StringConstants.kLblProjectManager)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                        Button(action: {
                            clientSignupprojThreeViewModel.nextScreen = "ClientSignuppropFourView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        .padding(.horizontal, getRelativeWidth(44.0))
                        Button(action: {
                            clientSignupprojThreeViewModel.nextScreen = "ClientSignuptrustFiveView"
                        }, label: {
                            HStack(spacing: 0) {
                    ...
                    Group {
                        Button(action: {
                            clientSignupprojThreeViewModel.nextScreen = "ClientSignuphmoSixView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        .padding(.horizontal, getRelativeWidth(44.0))
                        Button(action: {
                            clientSignupprojThreeViewModel.nextScreen = "ClientSignuphmoSevenView"
                        }, label: {
                            HStack(spacing: 0) {
                ...
                Group {
                    NavigationLink(destination: ClientSignuppropFourView(),
                                   ...
                                   selection: $clientSignupprojThreeViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ClientSignupprojThreeView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignupprojThreeView()
    }
}
