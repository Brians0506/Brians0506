...
struct SPSignuplocationView: View {
    @StateObject var sPSignuplocationViewModel = SPSignuplocationViewModel()
            ...
            VStack {
                VStack {
                    ...
                    Text(StringConstants.kLblLocation)
                        ...
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(95.0), height: getRelativeHeight(31.0),
                               alignment: .topLeading)
                        .padding(.top, getRelativeHeight(12.0))
                        .padding(.horizontal, getRelativeWidth(131.0))
                    Text(StringConstants.kMsgCityStateZi)
                        .font(FontScheme.kSarabunMediumItalic(size: getRelativeHeight(14.0)))
                        .fontWeight(.medium)
                        .foregroundColor(ColorConstants.Black900)
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(126.0), height: getRelativeHeight(19.0),
                               alignment: .topLeading)
                    ...
                    HStack {
                        ...
                        Image("img_forward")
                            ...
                            .clipped()
                            .onTapGesture {
                                sPSignuplocationViewModel.nextScreen = "SPSignupemailView"
                            }
                    }
                ...
                Group {
                    NavigationLink(destination: SPSignupemailView(),
                                   ...
                                   selection: $sPSignuplocationViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SPSignuplocationView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignuplocationView()
    }
}
