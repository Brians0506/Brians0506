...
struct ClientSignuplanguageView: View {
    @StateObject var clientSignuplanguageViewModel = ClientSignuplanguageViewModel()
            ...
            VStack {
                VStack {
                    ...
                    Text(StringConstants.kLblEnglish)
                        ...
                        .padding(.horizontal, getRelativeWidth(36.0))
                        .onTapGesture {
                            clientSignuplanguageViewModel.nextScreen = "ClientSignuplanguageOneView"
                        }
                    Text(StringConstants.kLblSpanish)
                        ...
                        .padding(.horizontal, getRelativeWidth(36.0))
                        .onTapGesture {
                            clientSignuplanguageViewModel.nextScreen = "ClientSignuplanguageTwoView"
                        }
                    Button(action: {
                        clientSignuplanguageViewModel.nextScreen = "ClientSignuplanguageThreeView"
                    }, label: {
                        HStack(spacing: 0) {
                    ...
                    .padding(.horizontal, getRelativeWidth(36.0))
                    Button(action: {
                        clientSignuplanguageViewModel.nextScreen = "ClientSignuplanguageFourView"
                    }, label: {
                        HStack(spacing: 0) {
                ...
                Group {
                    NavigationLink(destination: ClientSignuplanguageThreeView(),
                                   ...
                                   selection: $clientSignuplanguageViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ClientSignuplanguageView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignuplanguageView()
    }
}
