...
struct SPSignuppastworkView: View {
    @StateObject var sPSignuppastworkViewModel = SPSignuppastworkViewModel()
            ...
            VStack {
                VStack {
                    ...
                    ZStack(alignment: .leading) {
                        Image("img_forward")
                            ...
                            .onTapGesture {
                                sPSignuppastworkViewModel.nextScreen = "SPSignuppastWorkErrorView"
                            }
                        Image("img_back_24x24")
                            ...
                            .padding(.trailing, getRelativeWidth(17.0))
                            .onTapGesture {
                                sPSignuppastworkViewModel.nextScreen = "SPSignuplincenseverfView"
                            }
                    }
                    .hideNavigationBar()
                ...
                Group {
                    NavigationLink(destination: SPSignuppastWorkErrorView(),
                                   ...
                                   selection: $sPSignuppastworkViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct SPSignuppastworkView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignuppastworkView()
    }
}
