...
struct ClientSignuplanguageThreeView: View {
    @StateObject var clientSignuplanguageThreeViewModel = ClientSignuplanguageThreeViewModel()
...
struct ClientSignuplanguageThreeView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignuplanguageThreeView()
    }
}
