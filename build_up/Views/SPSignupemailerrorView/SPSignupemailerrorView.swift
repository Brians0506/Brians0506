...
struct SPSignupemailerrorView: View {
    @StateObject var sPSignupemailerrorViewModel = SPSignupemailerrorViewModel()
...
struct SPSignupemailerrorView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupemailerrorView()
    }
}
