...
struct ClientSignuppropFourView: View {
    @StateObject var clientSignuppropFourViewModel = ClientSignuppropFourViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    Group {
                        ...
                        Text(StringConstants.kMsgPropertyManage)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignuppropFourViewModel.nextScreen = "ClientSignuppropOneView"
                            }
                        Text(StringConstants.kLblDeveloper)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignuppropFourViewModel.nextScreen = "ClientSignupdevTwoView"
                            }
                        ...
                        .padding(.horizontal, getRelativeWidth(44.0))
                        Button(action: {
                            clientSignuppropFourViewModel.nextScreen = "ClientSignuptrustFiveView"
                        }, label: {
                            HStack(spacing: 0) {
                    ...
                    Group {
                        Button(action: {
                            clientSignuppropFourViewModel.nextScreen = "ClientSignuphmoSixView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        .padding(.horizontal, getRelativeWidth(44.0))
                        Button(action: {
                            clientSignuppropFourViewModel.nextScreen = "ClientSignuphmoSevenView"
                        }, label: {
                            HStack(spacing: 0) {
                ...
                Group {
                    NavigationLink(destination: ClientSignuptrustFiveView(),
                                   ...
                                   selection: $clientSignuppropFourViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ClientSignuppropFourView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignuppropFourView()
    }
}
