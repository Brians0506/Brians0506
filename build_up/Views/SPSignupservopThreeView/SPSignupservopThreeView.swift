...
struct SPSignupservopThreeView: View {
    @StateObject var sPSignupservopThreeViewModel = SPSignupservopThreeViewModel()
            ...
            VStack {
                VStack {
                    ...
                    ZStack(alignment: .leading) {
                        ...
                        Image("img_back_24x24")
                            ...
                            .onTapGesture {
                                sPSignupservopThreeViewModel.nextScreen = "SPSignupcompanyView"
                            }
                    }
                    .hideNavigationBar()
                ...
                Group {
                    NavigationLink(destination: SPSignupcompanyView(),
                                   ...
                                   selection: $sPSignupservopThreeViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SPSignupservopThreeView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupservopThreeView()
    }
}
