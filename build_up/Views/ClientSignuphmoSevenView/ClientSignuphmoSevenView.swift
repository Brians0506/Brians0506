...
struct ClientSignuphmoSevenView: View {
    @StateObject var clientSignuphmoSevenViewModel = ClientSignuphmoSevenViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    Group {
                        ...
                        Text(StringConstants.kMsgPropertyManage)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignuphmoSevenViewModel.nextScreen = "ClientSignuppropOneView"
                            }
                        Text(StringConstants.kLblDeveloper)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignuphmoSevenViewModel.nextScreen = "ClientSignupdevTwoView"
                            }
                        Text(StringConstants.kLblProjectManager)
                            ...
                            .padding(.horizontal, getRelativeWidth(44.0))
                            .onTapGesture {
                                clientSignuphmoSevenViewModel
                                    .nextScreen = "ClientSignupprojThreeView"
                            }
                        Button(action: {
                            clientSignuphmoSevenViewModel.nextScreen = "ClientSignuppropFourView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        .padding(.horizontal, getRelativeWidth(44.0))
                        Button(action: {
                            clientSignuphmoSevenViewModel.nextScreen = "ClientSignuptrustFiveView"
                        }, label: {
                            HStack(spacing: 0) {
                    ...
                    Group {
                        Button(action: {
                            clientSignuphmoSevenViewModel.nextScreen = "ClientSignuphmoSixView"
                        }, label: {
                            HStack(spacing: 0) {
                ...
                Group {
                    NavigationLink(destination: ClientSignupEmailView(),
                                   ...
                                   selection: $clientSignuphmoSevenViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ClientSignuphmoSevenView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignuphmoSevenView()
    }
}
