...
struct SPSignupcompanysizeoptionSixView: View {
    @StateObject var sPSignupcompanysizeoptionSixViewModel = SPSignupcompanysizeoptionSixViewModel()
    ...
    var body: some View {
            ...
            VStack {
                VStack {
                    ...
                    Text(StringConstants.kLblCompanySize)
                        ...
                        .padding(.horizontal, getRelativeWidth(36.0))
                    Button(action: {
                        sPSignupcompanysizeoptionSixViewModel
                ...
                Group {
                    NavigationLink(destination: SPSignupservTimeView(),
                                   ...
                                   selection: $sPSignupcompanysizeoptionSixViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
        ...
        .hideNavigationBar()
        .onAppear {
            sPSignupcompanysizeoptionSixViewModel.nextScreen = "SPSignupservTimeView"
        }
    }
}

struct SPSignupcompanysizeoptionSixView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupcompanysizeoptionSixView()
    }
}
