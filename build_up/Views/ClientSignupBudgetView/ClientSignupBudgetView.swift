...
struct ClientSignupBudgetView: View {
    @StateObject var clientSignupBudgetViewModel = ClientSignupBudgetViewModel()
        ...
        VStack {
            VStack {
                ...
                Text(StringConstants.kMsgEstimatedBudge)
                    ...
                    .minimumScaleFactor(0.5)
                    .multilineTextAlignment(.leading)
                    .frame(width: getRelativeWidth(332.0), height: getRelativeHeight(31.0),
                           alignment: .topLeading)
...
struct ClientSignupBudgetView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignupBudgetView()
    }
}
