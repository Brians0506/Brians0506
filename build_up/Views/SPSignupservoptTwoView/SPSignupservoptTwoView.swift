...
struct SPSignupservoptTwoView: View {
    @StateObject var sPSignupservoptTwoViewModel = SPSignupservoptTwoViewModel()
            ...
            VStack {
                VStack {
                    ...
                    ZStack(alignment: .leading) {
                        ...
                        Image("img_back_24x24")
                            ...
                            .onTapGesture {
                                sPSignupservoptTwoViewModel.nextScreen = "SPSignupcompanyView"
                            }
                    }
                    .hideNavigationBar()
                ...
                Group {
                    NavigationLink(destination: SPSignupcompanyView(),
                                   ...
                                   selection: $sPSignupservoptTwoViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SPSignupservoptTwoView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupservoptTwoView()
    }
}
