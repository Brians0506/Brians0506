...
struct SPSignupserviceyearsFourView: View {
    @StateObject var sPSignupserviceyearsFourViewModel = SPSignupserviceyearsFourViewModel()
...
struct SPSignupserviceyearsFourView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupserviceyearsFourView()
    }
}
