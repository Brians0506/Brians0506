...
struct SPSignupservERRORView: View {
    @StateObject var sPSignupservERRORViewModel = SPSignupservERRORViewModel()
...
struct SPSignupservERRORView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupservERRORView()
    }
}
