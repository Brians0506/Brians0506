...
struct ClientSignuppropOneView: View {
    @StateObject var clientSignuppropOneViewModel = ClientSignuppropOneViewModel()
            ...
            VStack {
                VStack {
                    Group {
                        ...
                        Text(StringConstants.kLblDeveloper)
                            ...
                            .padding(.horizontal, getRelativeWidth(36.0))
                            .onTapGesture {
                                clientSignuppropOneViewModel.nextScreen = "ClientSignupdevTwoView"
                            }
                        Text(StringConstants.kLblProjectManager)
                            ...
                            .padding(.horizontal, getRelativeWidth(36.0))
                            .onTapGesture {
                                clientSignuppropOneViewModel
                                    .nextScreen = "ClientSignupprojThreeView"
                            }
                        Button(action: {
                            clientSignuppropOneViewModel.nextScreen = "ClientSignuppropFourView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        .padding(.horizontal, getRelativeWidth(36.0))
                        Button(action: {
                            clientSignuppropOneViewModel.nextScreen = "ClientSignuptrustFiveView"
                        }, label: {
                            HStack(spacing: 0) {
                    ...
                    Group {
                        Button(action: {
                            clientSignuppropOneViewModel.nextScreen = "ClientSignuphmoSixView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        .padding(.horizontal, getRelativeWidth(36.0))
                        Button(action: {
                            clientSignuppropOneViewModel.nextScreen = "ClientSignuphmoSevenView"
                        }, label: {
                            HStack(spacing: 0) {
                ...
                Group {
                    NavigationLink(destination: ClientSignuphmoSixView(),
                                   ...
                                   selection: $clientSignuppropOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ClientSignuppropOneView_Previews: PreviewProvider {
    static var previews: some View {
        ClientSignuppropOneView()
    }
}
