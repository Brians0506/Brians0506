...
struct SignupasClientPickView: View {
    @StateObject var signupasClientPickViewModel = SignupasClientPickViewModel()
        ...
        NavigationView {
            VStack {
                VStack {
                    ...
                    .hideNavigationBar()
                    .onTapGesture {
                        signupasClientPickViewModel.nextScreen = "ClientSignupnameView"
                    }
                    ...
                    Button(action: {
                        ...
                        HStack(spacing: 0) {
                            Text(StringConstants.kLblClient)
                                .font(FontScheme
                                    .kMulishItalicRegular(size: getRelativeHeight(12.0)))
                                .fontWeight(.regular)
                ...
                Group {
                    NavigationLink(destination: ClientSignupnameView(),
                                   ...
                                   selection: $signupasClientPickViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SignupasClientPickView_Previews: PreviewProvider {
    static var previews: some View {
        SignupasClientPickView()
    }
}
