...
struct SPSignupcardinfoView: View {
    @StateObject var sPSignupcardinfoViewModel = SPSignupcardinfoViewModel()
    ...
    var body: some View {
        VStack {
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack {
                        ...
                        Text(StringConstants.kLblPayment)
                            ...
                            .minimumScaleFactor(0.5)
                            .multilineTextAlignment(.leading)
                            .frame(width: getRelativeWidth(99.0), height: getRelativeHeight(31.0),
                                   alignment: .topLeading)
                            ...
                            Group {
                                HStack {
                                    TextField(StringConstants.kLblNameOnCard,
                                              text: $sPSignupcardinfoViewModel.groupfiftysixText)
                                        .font(FontScheme
                                ...
                                .onChange(of: sPSignupcardinfoViewModel
                                    .groupfiftysixText) { newValue in

                                        sPSignupcardinfoViewModel
                                            .isValidGroupfiftysixText = newValue
                                ...
                                if !sPSignupcardinfoViewModel.isValidGroupfiftysixText {
                            ...
                            Group {
                                HStack {
                                    TextField(StringConstants.kLblCardNumber,
                                              text: $sPSignupcardinfoViewModel.groupfiftyfiveText)
                                        .font(FontScheme
                                            .kMulishRomanMedium(size: getRelativeHeight(16.0)))
                                        .foregroundColor(ColorConstants.Black900)
                                        .padding()
                                ...
                                .onChange(of: sPSignupcardinfoViewModel
                                    .groupfiftyfiveText) { newValue in

                                        sPSignupcardinfoViewModel
                                            .isValidGroupfiftyfiveText = newValue
                                ...
                                .padding(.horizontal, getRelativeWidth(1.0))
                                if !sPSignupcardinfoViewModel.isValidGroupfiftyfiveText {
                            ...
                            HStack {
                                HStack {
                                    TextField(StringConstants.kLblCvv,
                                              text: $sPSignupcardinfoViewModel.groupfiftyfourText)
                                        .font(FontScheme
                                            .kMulishRomanMedium(size: getRelativeHeight(16.0)))
                                        .foregroundColor(ColorConstants.Black900)
                                        .padding()
                                ...
                                HStack {
                                    TextField(StringConstants.kLblMmYy,
                                              text: $sPSignupcardinfoViewModel.groupfiftythreeText)
                                        .font(FontScheme
                                            .kMulishRomanMedium(size: getRelativeHeight(16.0)))
                                        .foregroundColor(ColorConstants.Black900)
                                        .padding()
            ...
            .padding(.vertical, getRelativeHeight(90.0))
...
struct SPSignupcardinfoView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupcardinfoView()
    }
}
