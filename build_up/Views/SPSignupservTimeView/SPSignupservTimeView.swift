...
struct SPSignupservTimeView: View {
    @StateObject var sPSignupservTimeViewModel = SPSignupservTimeViewModel()
            ...
            VStack {
                VStack {
                    ...
                    HStack {
                        Image("img_back_24x24")
                            ...
                            .clipped()
                            .onTapGesture {
                                sPSignupservTimeViewModel.nextScreen = "SPSignupcompanyView"
                            }
                        Spacer()
                        Image("img_forward")
                            .resizable()
                ...
                Group {
                    NavigationLink(destination: SPSignupcompanyView(),
                                   ...
                                   selection: $sPSignupservTimeViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct SPSignupservTimeView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupservTimeView()
    }
}
