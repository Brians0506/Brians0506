...
struct SignupasSPselectView: View {
    @StateObject var signupasSPselectViewModel = SignupasSPselectViewModel()
...
struct SignupasSPselectView_Previews: PreviewProvider {
    static var previews: some View {
        SignupasSPselectView()
    }
}
