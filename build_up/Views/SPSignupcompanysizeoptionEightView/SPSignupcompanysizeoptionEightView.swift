...
struct SPSignupcompanysizeoptionEightView: View {
    @StateObject var sPSignupcompanysizeoptionEightViewModel =
        SPSignupcompanysizeoptionEightViewModel()
            ...
            VStack {
                ...
                Group {
                    NavigationLink(destination: SPSignuptradeView(),
                                   ...
                                   selection: $sPSignupcompanysizeoptionEightViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct SPSignupcompanysizeoptionEightView_Previews: PreviewProvider {
    static var previews: some View {
        SPSignupcompanysizeoptionEightView()
    }
}
